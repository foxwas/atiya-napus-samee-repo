...
public class Inventory
{
   ...
   // DONE: Declare a field to hold a MusicItem for the Inventory-MusicItem relationship
   // DONE: Declare getter and setter methods for this field
   // DONE: Add annotations to declare the relationship.
   @ManyToOne
